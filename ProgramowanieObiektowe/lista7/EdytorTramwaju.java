...
public class EdytorTramwaju extends JFrame implements Serializable, ActionListener
{
	...
	public EdytorTramwaju( String s )
	{
		initUI();
		p = new Tramwaj();
	...
	{
		p = new Tramwaj( Producent.getText(), Model.getText(), Integer.parseInt( Rok.getText() ) );
	}
	...
	public void ReadFromFile(File file)
	{
		try
		{
			...
			p = new Tramwaj( P, M, Integer.parseInt(R) );
			ReadPojazd();
			in.close();
		}
		catch (FileNotFoundException e1) {}
