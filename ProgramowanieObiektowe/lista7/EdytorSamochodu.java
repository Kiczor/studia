...
public class EdytorSamochodu extends JFrame implements Serializable, ActionListener
{
	...
	public EdytorSamochodu( String s )
	{
		initUI();
		p = new Samochod();
	...
	{
		p = new Samochod( Producent.getText(), Model.getText(), Integer.parseInt( Rok.getText() ) );
	}
	...
	public void ReadFromFile(File file)
	{
		try
		{
			...
			p = new Samochod( P, M, Integer.parseInt(R) );
			ReadPojazd();
			in.close();
		}
		catch (FileNotFoundException e1) {}
